...
- **Before `/gsd-verify-work`:** full gate green, install matrix complete, and one full manual
  acceptance pass on Windows and on the Android TV box, on a clean profile, both logs archived.
...
| SETUP-06 | Clean profile + real Android TV box | — | **manual** | Windows half verified; Android half outstanding | partial | ⬜ pending |
| CI-06 | Manual acceptance on Windows and Android TV | — | **manual** | Manual acceptance matrix | n/a | ⬜ pending |
...
| Android TV acceptance with a remote | CI-06, SETUP-06 | Nothing about a 10-foot interface is verifiable from a desktop | Clean profile on the real box; navigate with the remote only; archive `kodi.log` |
