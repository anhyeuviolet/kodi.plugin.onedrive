...
- [ ] 03-08-PLAN.md — Swap the broker for the device-code client: provider, account identity, and the two-clock sign-in loop
- [ ] 03-09-PLAN.md — Account list with re-authorise, an explicit action mapping, and a log that carries no credentials
- [ ] 03-10-PLAN.md — The background service's proactive refresh, which never prompts
- [ ] 03-11-PLAN.md — The versioned settings schema, the Expert-level custom `client_id`, and the last broker rows
- [ ] 03-12-PLAN.md — The disclaimer, the README and the modification record
...
| 3. Authentication | 7/14 | In Progress|  |
